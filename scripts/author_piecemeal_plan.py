    ...
    return {
        ...
        "source_register": [
            ...
            },
            {
                "id": "POPPER",
                "type": "primary_book",
                "citation": "Popper, The Logic of Scientific Discovery (1959), sections 2-3, 18, and 29-30; Conjectures and Refutations (1963), chapter 1; Objective Knowledge (1972/1979), chapter 3.",
                "anchors": ["deductive criticism and auxiliary conditions", "theory-interpreted observation and predeclared refutation", "P1 -> TT -> EE -> P2 and theory-laden sense organs"],
                "direct_imports": [
                    ...
                    "an adverse result initially criticizes the conjunction of target theory, initial conditions, and auxiliaries",
                    ...
                    "scientific criticism can eliminate theories in place of their holders through P1 -> TT -> EE -> P2",
                ],
            ...
            },
            {
                ...
                "direct_imports": [
                    "human knowledge uses conjecture and criticism while biological knowledge uses variation and selection",
                    "their mechanisms and explanatory reach differ",
                    "sensory outputs and their interpretations are fallible and require explanatory links",
                    "variation and selection during a program run do not by themselves establish that the candidate created knowledge during that run",
                ],
                "poietic_operationalization": "An attribution must distinguish knowledge created in the candidate process from knowledge supplied by designers, prompts, training, tools, scores, or external sources.",
                "scope_limit": "A fixed reward score or black-box behavior is not a proof of creativity, and an agreeing result is not confirmation.",
            },
        ],
        "lattices": {
            ...
            "critical_evidence": lattice(
                ...
                verdicts=["REFUTED_CONJUNCTION", "SURVIVED_DECLARED_ATTEMPT", "INTERPRETATION_DISPUTED", "INCONCLUSIVE"],
            ...
            "explanatory_creativity": lattice(
                ...
                verdicts=["CRITICISABLE_TRACE_AUDITED", "PROVENANCE_UNRESOLVED", "NOT_ESTABLISHED", "REFUTED_ON_DECLARED_DOMAIN"],
        ...
        "negative_controls": [
            ...
            },
            {
                ...
                "fixture": "A declared test result agrees with a prediction, but is treated as confirming the target explanation.",
