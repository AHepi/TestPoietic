...
| PIN-CONS-v1 (`PIN_CONS_V1.md`) | Original-side pins for the ConservativeExtension / boundary-move cluster (DSF-v1 Section 13 item 5): CE-strong conservativity (D1), label-under-embedding (D2 on declared datum D2a), port program-preserved (D3), FiniteVariantSuite reading (D5), axioms A1 (no-splicing) and A2 (Everettian negative guard-rail); RetainsOrAdapts and Everettian positive semantics left OPEN. Feeds N7/N20 cones; D0/A1 gate untouched. The pinned term catalog (ORIGINAL_TERMS_INVENTORY.md, fe4e1f9a...) is a digest-pinned parent. | `3c5c17e98e69f0de6e22dfbce14b18c2fc1093066c5475f99c43a749d0df0d3a` / `6e0ecd77d0d09ebc790bcf89eed9400a0fc1c0ae91b38ec71b7121c689da7f5e` | independent first-pass REVISE (6 findings), repaired; repair review PASS by orchestrator hand-review (independence downgraded — reviewer pool unavailable); DRAFT_PENDING_REVIEW, not sealed |
| PIN-VE-v1 (`PIN_VE_V1.md`) | Original-side pins for the VE-identity pair (DSF-v1 family D16, N15 cone): RepresentedConjecture as declared content tokens with derives-link (D1); TheoryMediatedCriticism as account-derived discriminator (D2), constrained to keep the frozen V_FALLIBILITY row coherent. Non-deciding via S1/S2 pair. PIN-VE-OPEN-1 records the V_FALLIBILITY satisfiability re-check obligation on any future TMC tightening. | `1c074cf7eef9ad473e63a4fe50621985282b2a018f1fea33da30218fa6c493aa` / `d1b13c5c05f5bf54ce4a9fa3c72e5f9a345f77ecbe1bd3f94753685cf19d3696` | orchestrator hand-review PASS (independence downgraded); DRAFT_PENDING_REVIEW, not sealed |
| PIN-SUB-v1 (`PIN_SUB_V1.md`) | Joint original-side pin of the N18 pair (DSF-v1 family D19): SameSyntax as presentation equality (D1), RealizationEq as (T,E)-relative counterfactual role equality (D2), PIN-SUB-A1 joint independence (both swap-exists and no-swap structures exhibited); K_REALIZATION_EQUIVALENCE existential undecided; N18 DO NOT TEST OR REPAIR preserved. PIN-SUB-OPEN-1 records the degenerate-structure variant-family question. | `5338ffa35f5248219cc748f274be8e59ca32a944e5f0bd1762ae78fa6af1b136` / `7f1f21c2c67c95e40dc9b623573211fea6f769688b8e5adbc38e232b8d0e4c43` | orchestrator hand-review PASS (independence downgraded); DRAFT_PENDING_REVIEW, not sealed |
| PIN-ROLE-v1 (`PIN_ROLE_V1.md`) | Original-side pins for the role cluster (N17: RoleEq, SecondSubstance, CausalExemption; N19: OneObservedToken, CounterfactualFamilyObserved, ReplicationRole) plus PIN-ROLE-D7 resolving PIN-CONS-OPEN-1 (RetainsOrAdapts as role-profile preservation, conditional on PIN-SUB-v1's seal). Two-sided checks per row (M-hi/M-lo, M-one/M-fam, M-ret/M-noret). | `4285beaf2bbc852f858408ccf73e774e1fd6ee53e2f940c8f62527e6e8572dbf` / `07ec7c33b5a58e8af87aa0d3df8e260695276b0c1bf14ce8991769a3eef82bd6` | orchestrator hand-review PASS (independence downgraded); DRAFT_PENDING_REVIEW, not sealed |
| PIN-EPIST-v1 (`PIN_EPIST_V1.md`) | Original-side pins for the ten-leaf epistemic cluster (rows N8/N9/N10/N12/N13/N14/N16; families D8/D13/D14/D15/D17): declaration-level by design, with PIN-EPIST-A1 restating calculus (30)'s survival-not-confirmation non-implication as a certificate constraint. CreativeGenerator/CreativeCap independence required by construction (N9's double denial); NoPossibleCritic given the declared-space reading; Artifact/ArtifactClassified_eta ambiguity named PIN-EPIST-OPEN-2, not resolved. With this record every Section 12 leaf is pinned by a named record or carried as a named OPEN item. | `616366beb2be320fc3d90ffe97d5225b189e0feb5b05d9f96ba7869742804912` / `8e4ce9a31b410694f6534215838f3e931d8f1e493726337ab9a3819aa864c755` | orchestrator hand-review PASS (independence downgraded); DRAFT_PENDING_REVIEW, not sealed |
| BRV-v1 (`BRIDGE_REVIEW_V1.md`) | Bridge review (DSF-v1 Section 13 item 6): all four registered bridges graded, adequacy/circularity/no-splicing checked; inventory closed. B1 adequate-but-terminal; B2 expressible post-IDF-v1, open until a fixture exhibits the shared map; B3/B4 open pending IC-SP-001/002. Nothing promoted. Completes the semantics-first frozen order. | `5ddd3fd08169d54d7473b8c1fe9f866acc690edd44c1a93679b2e7c871eb2715` / `69ba63d3c4c9b34432d712674ad7cddae968d5b2872c9f9eab7efaa33dbb547c` | orchestrator hand-review PASS (independence downgraded); DRAFT_PENDING_REVIEW, not sealed |
